...
auto box(const std::string &title, const std::string &contents, uint32_t width = DEFAULT_BOX_WIDTH) -> std::string;
auto box(const std::string &title, const std::vector<std::string> &lines, uint32_t width = DEFAULT_BOX_WIDTH) -> std::string;
